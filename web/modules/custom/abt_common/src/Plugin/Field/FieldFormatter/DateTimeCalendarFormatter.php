...
/**
 * Plugin implementation of the 'Date calendar' formatter for 'datetime' fields.
 *
 * @FieldFormatter(
 *   id = "datetime_calendar",
 *   label = @Translation("Date calendar"),
 *   field_types = {
 *     "daterange"
 *   }
 * )
 */
class DateTimeCalendarFormatter extends DateRangeCustomFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements[$delta]['#start_day'] = $this->dateFormatter->format($start_timestamp, 'custom', 'l');
      ...
      $elements[$delta]['#start_time'] = $this->dateFormatter->format($start_timestamp, 'custom', 'g:ia');
      $elements[$delta]['#end_time'] = $this->dateFormatter->format($end_timestamp, 'custom', 'g:ia');
