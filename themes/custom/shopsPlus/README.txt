...
=====================
Introduction to Shops Plus
=====================

Shops Plus boasts a clean HTML5 structure with extensible CSS classes and IDs for
...
Shops Plus's goal is to provide themers the building blocks needed to get their
designs up and running quickly and simply.

Shops Plus is perfect if you want a simple, smart, and flexible theme starter.
...
Shops Plus utilizes SASS for adaptive grids and layouts and general structure of the
...
Shops Plus is meant to be YOUR theme. Follow one of the two methods below and you can
rename 'shopsPlus' to another name like 'mytheme'. You're also welcome to keep
'shopsPlus'.

1. DRUSH: The provided drush install script will duplicate the shopsPlus theme
   folder and rename all appropriate files and content to the new theme name you
   provide.

  - Download and enable the shopsPlus theme: $ drush en shopsPlus
  - Set the theme as default $ drush config-set system.theme default shopsPlus
    or copy the includes/shopsPlus.drush.inc into your .drush folder.
  - Run the provided drush install script: $ drush shopsPlus-install
  ...
  - At this time, you can uninstall shopsPlus: $drush pmu shopsPlus
...
2. MANUAL: To manually change the name of the theme follow these steps BEFORE
  ...
  - Rename shopsPlus.info.yml to mytheme.info.yml
  - edit shopsPlus.info.yml and change the name, description, project (can be
    deleted), and change all other instances of 'shopsPlus' to 'mytheme'
  - Rename shopsPlus.libraries.yml to mytheme.libraries.yml
  - Rename shopsPlus.theme to mytheme.theme
  - in shopsPlus.theme, change each instance of 'shopsPlus' to 'mytheme'
  - Rename config/schema/shopsPlus.schema.yml to mytheme.schema.yml
  - Rename each file in config/install from block.block.shopsPlus_tools.yml (for
    example) to block.block.mytheme_tools.yml
  - Every file in config/install, change each instance of 'shopsPlus' to
    'mytheme'
  - In js/source/scripts.js, change each instance of 'shopsPlus' to 'mytheme'
  - In theme-settings.php, change each instance of 'shopsPlus' to 'mytheme'
  - In templates/html.html.twig, change each instance of 'shopsPlus' to 'mytheme'
  - In templates/menu-local-tasks.html.twig, change each instance of 'shopsPlus' to
    'mytheme'
  - In templates/status-messages.html.twig, change each instance of 'shopsPlus' to
    'mytheme'

  When renaming, remember the following:
  - Do not simply replace every instance of 'shopsPlus' in every file in the theme.
    Most of Shops Plus's dependencies use the word 'shopsPlus' somewhere and renaming
    these instances will cause Shops Plus to break in unpredictable ways.
  ...
  - If you don't bother renaming Shops Plus in the above locations, be advised that
    you will run into conflicts with other versions of Shops Plus on your site. If
    your site uses more than one theme based on Shops Plus, make sure at least one of
    the themes has been renamed properly!


============================
How to compile SASS in Shops Plus
============================

To use SASS and automatically compile it within your theme, please refer to "How
to Use Grunt with Shops Plus" in the documentation below.
...
- build/scripts.js & source/scripts.js
  ...
  folder. See comments in shopsPlus.libraries.yml file to enable the starter
  scripts.js file.
...
The layout used in Shops Plus is fairly similar to the Holy Grail method. It has been
...
This is how the page template is buit in Shops Plus, and it works in fluid and fixed
layout. Refer to the notes in layout.sass to see how to modify the layout.


===========================
How to Use Grunt with Shops Plus
===========================
...
Once Node.JS is installed, go to the root folder of Shops Plus and install your Grunt
packages:
...
Once installed, cd to the root folder of Shops Plus and run Grunt via the command
line:
...
Once you start using Shops Plus, you will massively change it until you reach the
point where it has nothing to do with Shops Plus anymore. Unlike Zen, Shops Plus is not
...
version of Shops Plus comes out. Always see Shops Plus as a STARTER, and as soon as you
start using it, it is not Shops Plus anymore, but your own theme.

If you didn't rename your theme, but you don't want to be notified when Shops Plus
has a new version by the update module, simply delete "project = "shopsPlus" in
shopsPlus.info.yml.
...
Thanks for using Shops Plus, and remember to use the issue queue in drupal.org for
any questions or bug reports:

http://drupal.org/project/issues/shopsPlus
